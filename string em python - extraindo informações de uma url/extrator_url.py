...
class ExtratorURL():
    ...
    def valida_url(self):
        if not self.url: # esse "not" ele inverte os papeis por baixo dos panos, ele vai pegar o valor True e vai passar a ser False
    ...
    def get_valor_parametro(self, parametro_busca):
        indice_parametro = self.get_url_parametros().find(parametro_busca)  # encontra o indice do meu parametro
        indice_valor = indice_parametro + len(parametro_busca) + 1  # encontra o indice do meu valor
        indice_e_comercial = self.get_url_parametros().find('&', indice_valor)  # encontra o indice do meu & comercial
...
if moeda_destino == "real" and moeda_destino == "dolar":
